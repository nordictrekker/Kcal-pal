...
export async function parseTextMeal(
  ...
  opts: { forceSupplementSearch?: boolean } = {},
): Promise<ParseResult> {
  const userContent =
    history.length === 0
      ? description
